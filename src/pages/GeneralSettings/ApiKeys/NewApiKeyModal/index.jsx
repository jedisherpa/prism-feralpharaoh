    ...
    <ModalWrapper isOpen={true}>
      <div className="relative w-full max-w-2xl metacanon-modal-panel bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border">
        <div className="relative p-6 border-b rounded-t border-theme-modal-border">
          ...
          <PrismHoverTarget targetId="modal-api-key-close">
            <button
              onClick={closeModal}
              type="button"
        ...
        <div className="px-7 py-6">
          <form onSubmit={handleCreate}>
            <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
              ...
              {apiKey && (
                <div className="relative">
                  ...
                  <PrismHoverTarget targetId="modal-api-key-copy-icon">
                    <button
                      type="button"
                      onClick={copyApiKey}
                      disabled={copied}
            ...
            <div className="flex justify-end items-center mt-6 pt-6 border-t border-theme-modal-border">
              {!apiKey ? (
                <>
                  <PrismHoverTarget targetId="modal-api-key-cancel">
                    <button
                      onClick={closeModal}
                      type="button"
                  ...
                  <PrismHoverTarget targetId="modal-api-key-create">
                    <button
                      type="submit"
                ...
                <PrismHoverTarget targetId="modal-api-key-close-secondary">
                  <button
                    onClick={closeModal}
                    type="button"
